...
export const aboutValuePillars: AboutValuePillar[] = [
  {
    icon: "/images/about/pillar-icon.png",
    label: "AESTHETIC",
...
export const aboutFeatureSections: AboutFeatureSection[] = [
  {
    ...
    bg: "/images/about/feature/marketing-bg.png",
    icon: "/images/about/feature/marketing-icon.svg",
  },
  {
    eyebrow: "Video",
    ...
    bg: "/images/about/feature/video-bg.png",
    icon: "/images/about/feature/video-icon.svg",
  },
  {
    ...
    bg: "/images/about/feature/web-bg.png",
    icon: "/images/about/feature/web-icon.svg",
  },
];
